...
$(function () {
  $("input.date").datepicker({
    maxDate: getFirstOfNextMonth(),
    dateFormat: 'yy-mm-dd'
  });
  memberNameAutocomplete();
  $("#standby_start_date").change(standbyStartDateSelect);
  $("#collateralduty_start_date").change(collateraldutyStartDateSelect);
...
function collateraldutyStartDateSelect() {
  $("#collateralduty_end_date").val($(this).val());
}
